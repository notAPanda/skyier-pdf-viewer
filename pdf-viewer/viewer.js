...
/***/ (function(module, exports, __webpack_require__) {
    ...
    function getViewerConfiguration() {
      return {
        ...
        secondaryToolbar: {
          ...
          toggleButton: document.querySelector('#secondaryToolbarToggle svg'),
    ...
    var defaultOptions = {
      ...
      imageResourcesPath: {
        value: 'https://assets.filestack.com/viewer-assets/images/',
        kind: OptionKind.VIEWER
      },
      maxCanvasPixels: {
        value: 16777216,
    ...
    function () {
      ...
      _createClass(PDFPageView, [{
        ...
        value: function reset() {
          ...
          this.loadingIconDiv.innerHTML = '<svg class="spinner" viewBox="0 0 50 50"><circle class="path" cx="25" cy="25" r="20" fill="none" stroke-width="5"></circle></svg>';
